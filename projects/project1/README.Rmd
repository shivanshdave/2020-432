...
- Section 9 is now just the **Affirmation** that the data can bs shared with us, as we're moving the session info and references (if needed) to the bottom of the document.
